...
public class PlayerController : MonoBehaviour
{
    ...
    public bool canMovePlayer = true;//a flag to stop the player movement when needed
    public bool canMoveAnimte = true;//a flag to stop the player animation when needed
    ...
    public Signal playerHealthSignal;//reference to current signal for the health
    public Signal reduceMagic;//reference to the signal for the MagicBar
    public GameObject projectile;//GameObject for the FireBall
    public MapInventory playerInventory;//reference to Inventory
    public bool imAlive;//bool for checking that player alive
